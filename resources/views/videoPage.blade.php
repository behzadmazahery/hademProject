...
@section('content')
    ...
    <section class="main__box">
      ...
      <section class="video__list__item flex justify-center  ">
            ...
            <!-- video item -->
            <article class="video__item relative">
        ...
        <section class="global__box">
            ...
            <article class="input__search__box border-2 border-amber-500 flex items-center gap-2 px-3">
                <label class="pl-2"> عنوان </label>
                <input class="bg-transparent py-2 border-none outline-none flex-1" type="text" value="تدفین شهدا">
            </article>
